       ...
       */
        ...
        */
         ...
         */
         ...
         /**
          * Obtenir les attributs de l'instance courante(prénom, nom et la description)
          * sous forme de chaîne de caractères
          * 
          * @return le prénom, le nom et la description
          */
          public String toString (){
              return(obtenirDescription() 
            		  + DESCRPTION_PRENOM + getPrenom() 
            		  + DESCRPTION_NOM + getNom() );
          }
          
          /**
           * Obtenir la description d'une Personne
           * 
           * @return La description d'une personne
           */
