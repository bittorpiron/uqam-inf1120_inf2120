...
import ca.uqam.inf2120.labos.file.tda.impl.FilePleineException;
import ca.uqam.inf2120.labos.file.tda.FileVideException;
import ca.uqam.inf2120.labos.file.tda.impl.FileTableauImpl;
 ...
 */
public class FileTableauImplTest {
	...
	public void setUp() throws Exception {
		...
		uneFile =  new FileTableauImpl<Etudiant>();
	...
	public void testEnfiler() {
		...
		try {
			...
			for (int i = 0; i <= ((FileTableauImpl<Etudiant>)uneFile).TAILLE_MAX; i++) {
				uneFile.enfiler(etud4);
				
			}
		} catch (FilePleineException e) {
			 assertEquals("Aucune place pour ajouter un autre élément", e.getMessage());
		}
	}
